...
{
    /// <summary>
    /// Immutable request to remove the authoritative structure occupying a target map cell.
    /// </summary>
    public readonly struct StructureRemovalRequest : IEquatable<StructureRemovalRequest>
    {
        #region Initialization

        /// <summary>
        /// Initializes a new structure removal request.
        /// </summary>
        /// <param name="targetCell">A map cell that may be occupied by the structure to remove.</param>
        public StructureRemovalRequest(MapCellCoord targetCell)
        {
        ...
        public static bool operator ==(StructureRemovalRequest left, StructureRemovalRequest right)
        {
        ...
        public bool Equals(StructureRemovalRequest other)
        {
        ...
        {
            return obj is StructureRemovalRequest other && Equals(other);
        }
