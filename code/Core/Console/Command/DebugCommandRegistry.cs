namespace CosmosCasino.Core.Debug.Command
{
    ...
    /// </summary>
    internal sealed class DebugCommandRegistry
    {
        #region FIELDS
        ...
        internal DebugCommandRegistry(ConsoleManager debugConsole)
        {
            ...
            DebugCommandRegistrar.RegisterAll(Register, debugConsole);
        }
        ...
        internal CommandResult Execute(string input)
        {
            ...
            {
                return CommandResult.Failed($"Unknown command: {key}");
            }
        ...
        /// </exception>
        private void Register(IDebugCommand command)
        {
...
#if !DEBUG
            if (command.Safety == CommandSafety.Unsafe)
            {
                return;
            }
#endif
