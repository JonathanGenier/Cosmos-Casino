...
namespace CosmosCasino.Tests.Map
{
    ...
    internal class CellCoordTests
    {
        ...
        {
            var a = new CellCoord(1, 2, 3);
            var b = new CellCoord(1, 2, 3);
        ...
        {
            object a = new CellCoord(1, 2, 3);
            object b = new CellCoord(1, 2, 3);
        ...
        {
            var a = new CellCoord(5, 6, 7);
            var b = new CellCoord(5, 6, 7);
        ...
        {
            var dict = new Dictionary<CellCoord, string>();
            var key1 = new CellCoord(1, 2, 3);
            var key2 = new CellCoord(1, 2, 3);
