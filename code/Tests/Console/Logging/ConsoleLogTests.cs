...
namespace CosmosCasino.Tests.Console.Logging
{
    ...
    internal class ConsoleLogTests
    {
        ...
        {
            // Act
            ConsoleLog.Info("Unsafe", "Unsafe message", ConsoleLogSafety.Unsafe);
        ...
        {
            // Act
            ConsoleLog.Info("Unsafe", "Unsafe message", ConsoleLogSafety.Safe);
        ...
        [Test]
        public void ConsoleLog_AllowsExplicitSafetyOverride_ExceptForWarningErrorAndSystem()
        {
            // Act
            ConsoleLog.Info("Test", "Info", ConsoleLogSafety.Unsafe);
            ConsoleLog.Verbose("Test", "Verbose", ConsoleLogSafety.Safe);
            ConsoleLog.Event("Test", "Event", ConsoleLogSafety.Unsafe);
            ...
            Assert.That(logs.Count(e => e.Safety == ConsoleLogSafety.Safe), Is.EqualTo(1));
            Assert.That(logs.Count(e => e.Safety == ConsoleLogSafety.Unsafe), Is.EqualTo(2));
#else
        ...
        public void LogEntry_UsesCorrectDefaultLogKindPerApi()
        {
            ...
            ConsoleLog.Verbose("Test", "General", ConsoleLogSafety.Safe);
        ...
        public void OnLog_IsInvoked_ExactlyOnce_PerLog()
        {
            // Assemble
            int count = 0;
            void Handler(ConsoleLogEntry logEntry) => count++;
